...
type SettingsTab = 'profile' | 'preferences' | 'ai' | 'banks' | 'categories' | 'data';
...
export default function SettingsPage() {
  ...
  const handleSaveProfile = async (e: React.FormEvent) => {
    ...
    if (phone.trim() && !/^\+[1-9]\d{7,14}$/.test(phone.trim())) {
      setError('A mobile number with country code is required, for example +919876543210.');
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.16),transparent_34%),linear-gradient(180deg,#f8fafc_0%,#eef2ff_48%,#f8fafc_100%)]">
      ...
      <div className="fixed inset-0 overflow-y-auto bg-slate-950/50 px-4 py-6 backdrop-blur-sm sm:py-10">
        <main className="mx-auto w-full max-w-4xl overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl">
          {/* Header */}
          <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-slate-900 px-6 py-6 text-white">
            ...
            <div className="relative z-10 flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-medium text-blue-100">Account & Platform Settings</p>
                <h1 className="mt-1 text-2xl font-bold">Settings</h1>
                <p className="mt-2 max-w-xl text-sm text-blue-100">
                  Manage categories, bank accounts, regional formatting, AI models, data exports,
              ...
              <div className="flex items-center gap-2">
                {profile?.role === 'admin' && (
                  <Link
                    href="/admin"
                    className="rounded-full bg-white/20 px-3 py-1.5 text-xs text-white hover:bg-white/30 font-semibold cursor-pointer"
                  >
                    Admin Dashboard
                  </Link>
                )}
            ...
            <div className="relative z-10 mt-6 flex flex-wrap gap-2 border-t border-white/15 pt-4">
              <button
                ...
                className={`relative z-10 rounded-xl px-3.5 py-1.5 text-xs font-semibold transition-all cursor-pointer ${
                  activeTab === 'profile'
          ...
          {/* Body content */}
          <section className="max-h-[calc(100vh-14rem)] overflow-y-auto px-6 py-6">
            {error && (
            ...
            {activeTab === 'profile' && (
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="mt-6 grid gap-5 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-400">
                        Example: +919876543210. Used for account security.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="shrink-0 rounded-lg bg-emerald-50 border border-emerald-200 px-2.5 py-1 text-xs font-semibold text-emerald-700">
                          ✓ Verified
                        </span>
                      </div>
                      <p className="mt-1 text-xs text-gray-400">
                        Primary email used for sign-in and authentication.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={profile?.id || ''}
                        disabled
                        className="w-full font-mono text-xs rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-gray-500 cursor-not-allowed"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mt-6 flex justify-end">
                    <button
                      ...
                      className="rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow hover:bg-blue-700 disabled:opacity-50 transition cursor-pointer"
                    >
                          ...
                          <tbody className="divide-y divide-gray-200 bg-white">
                            ...
                            <tr>
                              <td className="px-4 py-3">
                                ...
                                <div className="text-xs text-gray-500">
                                  ACID transactional integrity, index maintenance, search & audit
                                  logs
                                </div>
                              </td>
                              <td className="px-4 py-3 text-gray-600 text-xs">
                ...
                {/* Danger Zone: Account Closure Card */}
            ...
            {activeTab === 'preferences' && (
              <form onSubmit={handleSavePreferences} className="space-y-6">
                <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Customize your display currency, timezone, number formatting, date format, and
                    time format.
                  </p>
                  ...
                  <div className="mt-6 grid gap-5 sm:grid-cols-2">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm text-gray-900 focus:border-blue-500 focus:outline-none"
                      >
                ...
                >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          const defModel =
                            provConf?.models.find((m) => m.isDefault)?.id ||
                            provConf?.models[0]?.id;
                  ...
                  <div className="mt-5 flex justify-end">
                    <button
                      type="submit"
                      disabled={isSavingAi}
                      className="rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow hover:bg-blue-700 disabled:opacity-50 cursor-pointer"
                    >
                      {isSavingAi ? 'Saving...' : 'Save AI Selection'}
                    </button>
                  </div>
                </form>
                    ...
                    <div className="rounded-2xl border border-blue-100 bg-blue-50/60 p-5 flex flex-col justify-between">
                      <div>
                        ...
                        <p className="mt-2 text-xs text-gray-600">
                          Contains complete structured JSON records of all your profile settings,
                          bank accounts, statements, draft extractions, transactions, categories,
                          bills, chat history, and consent records.
                        </p>
                      </div>
                      <button
                        type="button"
